!function(t, e) {
    ...
    C.extend({
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (p(Object(t)) ? C.merge(i, "string" == typeof t ? [t] : t) : l.call(i, t)),
            i
        },
    ...
    var f = function(i) {
        ...
        var t, p, _, o, r, f, u, m, w, l, c, x, E, a, T, g, h, v, y, C = "sizzle" + 1 * new Date, b = i.document, S = 0, n = 0, k = lt(), I = lt(), A = lt(), D = lt(), P = function(t, e) {
            return t === e && (c = !0),
            0
            ...
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, F = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", j = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", B = "\\[" + H + "*(" + j + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + j + "))|)" + H + "*\\]", R = ":(" + j + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + B + ")*)|.*)\\)|)", q = new RegExp(H + "+","g"), W = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$","g"), Y = new RegExp("^" + H + "*," + H + "*"), V = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), X = new RegExp(H + "|>"), G = new RegExp(R), U = new RegExp("^" + j + "$"), Q = {
            ID: new RegExp("^#(" + j + ")"),
            CLASS: new RegExp("^\\.(" + j + ")"),
            TAG: new RegExp("^(" + j + "|[*])"),
            ATTR: new RegExp("^" + B),
        ...
        }, K = /HTML$/i, Z = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, tt = /^[^{]+\{\s*\[native \w/, et = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, it = /[+~]/, nt = new RegExp("\\\\([\\da-f]{1,6}" + H + "?|(" + H + ")|.)","ig"), st = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ot = function(t, e) {
        ...
        function at(e, t, i, n) {
            ...
            "string" != typeof e || !e || 1 !== u && 9 !== u && 11 !== u)
                return i;
            if (!n && ((t ? t.ownerDocument || t : b) !== E && x(t),
            t = t || E,
            T)) {
                if (11 !== u && (l = et.exec(e)))
                    if (s = l[1]) {
                        ...
                        if ((s = l[3]) && p.getElementsByClassName && t.getElementsByClassName)
                            return $.apply(i, t.getElementsByClassName(s)),
                            i
                    }
                if (p.qsa && !D[e + " "] && (!g || !g.test(e)) && (1 !== u || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    d = t,
                    1 === u && X.test(e)) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(st, ot) : t.setAttribute("id", a = C),
                        o = (c = f(e)).length; o--; )
                            c[o] = "#" + a + " " + bt(c[o]);
                        h = c.join(","),
                        d = it.test(e) && vt(t.parentNode) || t
                    }
                    try {
                        return $.apply(i, d.querySelectorAll(h)),
                        i
                    } catch (t) {
                        D(e, !0)
                    } finally {
        ...
        x = at.setDocument = function(t) {
            ...
            T = !r(E),
            b !== E && (i = E.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", s, !1) : i.attachEvent && i.attachEvent("onunload", s)),
            ...
            h = [],
            g = [],
            (p.qsa = tt.test(E.querySelectorAll)) && (ht(function(t) {
                ...
                t.querySelectorAll("[selected]").length || g.push("\\[" + H + "*(?:value|" + F + ")"),
            ...
            : function(t, e) {
                ...
                if (!s || !o)
                    return t === E ? -1 : e === E ? 1 : s ? -1 : o ? 1 : l ? z(l, t) - z(l, e) : 0;
                if (s === o)
                    return ut(t, e);
        ...
        at.matchesSelector = function(t, e) {
            if ((t.ownerDocument || t) !== E && x(t),
            p.matchesSelector && T && !D[e + " "] && (!h || !h.test(e)) && (!g || !g.test(e)))
                try {
                    var i = v.call(t, e);
        ...
        at.contains = function(t, e) {
            return (t.ownerDocument || t) !== E && x(t),
            y(t, e)
        }
        ,
        ...
        (_ = at.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return Q.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && G.test(i) && (e = f(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(f, t, e, m, g) {
                    ...
                    : function(t, e, i) {
                        var n, s, o, r, a, l, c = v != y ? "nextSibling" : "previousSibling", h = t.parentNode, d = b && t.nodeName.toLowerCase(), u = !i && !b, p = !1;
                        if (h) {
                            if (v) {
                                for (; c; ) {
                                    for (r = t; r = r[c]; )
                            ...
                            y && u) {
                                for (p = (a = (n = (s = (o = (r = h)[C] || (r[C] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === S && n[1]) && n[2],
                                r = a && h.childNodes[a]; r = ++a && r && r[c] || (p = a = 0) || l.pop(); )
                                    if (1 === r.nodeType && ++p && r === t) {
                                        s[f] = [S, a, p];
                                        break
                                    }
                            } else if (u && (p = a = (n = (s = (o = (r = t)[C] || (r[C] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === S && n[1]),
                            !1 === p)
                                for (; (r = ++a && r && r[c] || (p = a = 0) || l.pop()) && ((b ? r.nodeName.toLowerCase() !== d : 1 !== r.nodeType) || !++p || (u && ((s = (o = r[C] || (r[C] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] = [S, p]),
                                r !== t)); )
                                    ;
                ...
                PSEUDO: function(t, o) {
                    ...
                    return r[C] ? r(o) : 1 < r.length ? (e = [t, t, "", o],
            ...
            pseudos: {
                ...
                lang: ct(function(i) {
                    return U.test(i || "") || at.error("unsupported lang: " + i),
        ...
        function _t(a, t, e) {
            ...
            : function(t, e, i) {
                ...
                if (i) {
                    ...
                    for (; t = t[l]; )
                        if (1 === t.nodeType || d)
                            if (s = (o = t[C] || (t[C] = {}))[t.uniqueID] || (o[t.uniqueID] = {}),
            ...
            ct(function(t, e, i, n) {
                var s, o, r, a = [], l = [], c = e.length, h = t || function(t, e, i) {
                    for (var n = 0, s = e.length; n < s; n++)
                        at(t, e[n], i);
                    return i
                }(f || "*", i.nodeType ? [i] : i, []), d = !p || !t && f ? h : xt(h, a, p, i, n), u = m ? v || (t ? p : c || g) ? [] : e : d;
                if (m && m(d, u, i, n),
                g)
                    for (s = xt(u, l),
                    g(s, [], i, n),
                ...
                if (t) {
                    if (v || p) {
                        ...
                        for (o = u.length; o--; )
                            (r = u[o]) && -1 < (s = v ? z(t, r) : a[o]) && (t[s] = !(e[s] = r))
                    }
                } else
                    u = xt(u === e ? u.splice(c, u.length) : u),
                    v ? v(null, e, u, n) : $.apply(e, u)
            })
        }
        function Tt(t) {
                ...
                if (e = _.relative[t[a].type])
                    ...
                    if ((e = _.filter[t[a].type].apply(null, t[a].matches))[C]) {
                        for (i = ++a; i < n && !_.relative[t[i].type]; i++)
                            ;
                        return Et(1 < a && wt(h), 1 < a && bt(t.slice(0, a - 1).concat({
                            value: " " === t[a - 2].type ? "*" : ""
                        })).replace(W, "$1"), e, a < i && Tt(t.slice(a, i)), i < n && Tt(t = t.slice(i)), i < n && bt(t))
                    }
                    h.push(e)
                }
            return wt(h)
        ...
        f = at.tokenize = function(t, e) {
            ...
            a = [],
            l = _.preFilter; r; ) {
                for (o in i && !(n = Y.exec(r)) || (n && (r = r.slice(n[0].length) || r),
                a.push(s = [])),
                i = !1,
                (n = V.exec(r)) && (i = n.shift(),
                s.push({
                    value: i,
                    type: n[0].replace(W, " ")
                }),
            ...
            if (!o) {
                ...
                (o = A(t, function(g, v) {
                    function t(t, e, i, n, s) {
                        var o, r, a, l = 0, c = "0", h = t && [], d = [], u = w, p = t || b && _.find.TAG("*", s), f = S += null == u ? 1 : Math.random() || .1, m = p.length;
                        for (s && (w = e === E || e || s); c !== m && null != (o = p[c]); c++) {
                            if (b && o) {
                                for (r = 0,
                                e || o.ownerDocument === E || (x(o),
                                i = !T); a = g[r++]; )
                                    if (a(o, e || E, i)) {
                                        n.push(o);
                                        break
                        ...
                        y && c !== l) {
                            ...
                            if (t) {
                                if (0 < l)
                                    for (; c--; )
                                        h[c] || d[c] || (d[c] = O.call(n));
                                d = xt(d)
                            }
                            $.apply(n, d),
                            s && !t && 0 < d.length && 1 < l + v.length && at.uniqueSort(n)
                        }
                        return s && (S = f,
                        w = u),
                        h
        ...
        m = at.select = function(t, e, i, n) {
            ...
            1 === h.length) {
                ...
                !_.relative[a = r.type]); )
                    if ((l = _.find[a]) && (n = l(r.matches[0].replace(nt, d), it.test(o[0].type) && vt(e.parentNode) || e))) {
                        if (o.splice(s, 1),
                        !(t = n.length && bt(o)))
                            return $.apply(i, n),
                            i;
            ...
            return (c || u(t, h))(n, e, !T, i, !e || it.test(t) && vt(e.parentNode) || e),
            i
        }
        ,
    ...
    (C.fn.init = function(t, e, i) {
        ...
        "string" != typeof t)
            ...
            this.length = 1,
            this) : b(t) ? void 0 !== i.ready ? i.ready(t) : t(C) : C.makeArray(t, this);
        if (!(n = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : M.exec(t)) || !n[1] && e)
            return !e || e.jquery ? (e || i).find(t) : this.constructor(e).find(t);
        if (n[1]) {
            if (e = e instanceof C ? e[0] : e,
            C.merge(this, C.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : T, !0)),
            A.test(n[1]) && C.isPlainObject(e))
                for (n in e)
                    b(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
            return this
        }
        return (s = T.getElementById(n[2])) && (this[0] = s,
        this.length = 1),
        this
    }
    ).prototype = C.fn,
    ...
    C.extend({
                        ...
                        return function() {
                            function t() {
                                ...
                                if (!(s < l)) {
                                    ...
                                    b(e) ? a ? e.call(t, c(l, o, z, a), c(l, o, F, a)) : (l++,
                                    e.call(t, c(l, o, z, a), c(l, o, F, a), c(l, o, z, o.notifyWith))) : (r !== z && (i = void 0,
                                    n = [t]),
                                    (a || o.resolveWith)(i, n))
                                }
                            }
                            ...
                            ;
                            s ? e() : (C.Deferred.getStackHook && (e.stackTrace = C.Deferred.getStackHook()),
                            E.setTimeout(e))
                        }
                    }
        ...
        when: function(t) {
            ...
            var i = arguments.length
              ...
              , o = a.call(arguments)
              , r = C.Deferred();
            if (i <= 1 && (H(t, r.done(e(n)).resolve, r.reject, !i),
    ...
    C.ready.then = B.then,
    "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? E.setTimeout(C.ready) : (T.addEventListener("DOMContentLoaded", R),
        ...
        data: function(i, t) {
            ...
            if (void 0 !== i)
                return "object" == typeof i ? this.each(function() {
                    ...
                    var e;
                    if (o && void 0 === t)
                        return void 0 !== (e = K.get(o, i)) ? e : void 0 !== (e = tt(o, i)) ? e : void 0;
                    this.each(function() {
                        K.set(this, i, t)
                    })
            ...
            1 === o.nodeType && !Q.get(o, "hasDataAttrs"))) {
                for (e = r.length; e--; )
                    r[e] && 0 === (n = r[e].name).indexOf("data-") && (n = X(n.slice(5)),
                    tt(o, n, s[n]));
    ...
    C.fn.extend({
        ...
        promise: function(t, e) {
            ...
            t = void 0),
            t = t || "fx"; a--; )
                (n = Q.get(r[a], t + "queueHooks")) && n.empty && (s++,
                n.empty.add(i));
            return i(),
            o.promise(e)
        }
    ...
    function ct(t, e, i, n) {
        ...
        , l = a(), c = i && i[3] || (C.cssNumber[e] ? "" : "px"), h = t.nodeType && (C.cssNumber[e] || "px" !== c && +l) && it.exec(C.css(t, e));
        if (h && h[3] !== c) {
            for (l /= 2,
            c = c || h[3],
            h = +l || 1; r--; )
    ...
    function dt(t, e) {
        for (var i, n, s, o, r, a, l, c = [], h = 0, d = t.length; h < d; h++)
            (n = t[h]).style && (i = n.style.display,
            e ? ("none" === i && (c[h] = Q.get(n, "display") || null,
            c[h] || (n.style.display = "")),
            "" === n.style.display && lt(n) && (c[h] = (l = r = o = void 0,
            r = (s = n).ownerDocument,
            a = s.nodeName,
    ...
    C.event = {
        ...
        add: function(e, t, i, n, s) {
            ...
            if (g)
                ...
                c = (t = (t || "").match(N) || [""]).length; c--; )
                    ...
                    d.setup && !1 !== d.setup.call(e, n, f, r) || e.addEventListener && e.addEventListener(p, r)),
            ...
            if (g && (l = g.events)) {
                for (c = (e = (e || "").match(N) || [""]).length; c--; )
                    ...
                    p) {
                        ...
                        r = o = u.length; o--; )
                            h = u[o],
                            !s && m !== h.origType || i && i.guid !== h.guid || a && !a.test(h.namespace) || n && n !== h.selector && ("**" !== n || !h.selector) || (u.splice(o, 1),
                            h.selector && u.delegateCount--,
                            d.remove && d.remove.call(t, h));
                        r && !u.length && (d.teardown && !1 !== d.teardown.call(t, f, g.handle) || C.removeEvent(t, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
        ...
        dispatch: function(t) {
            var e, i, n, s, o, r, a = C.event.fix(t), l = new Array(arguments.length), c = (Q.get(this, "events") || {})[a.type] || [], h = C.event.special[a.type] || {};
            for (l[0] = a,
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        ...
                        r = {},
                        i = 0; i < l; i++)
                            void 0 === r[s = (n = e[i]).selector + " "] && (r[s] = n.needsContext ? -1 < C(s, this).index(c) : C.find(s, this, null, [c]).length),
                            r[s] && o.push(n);
                        o.length && a.push({
                            elem: c,
                            handlers: o
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return ut.test(e.type) && e.click && I(e, "input") && At(e, "click", Ct),
                    !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return ut.test(e.type) && e.click && I(e, "input") && At(e, "click"),
                    !0
                },
                _default: function(t) {
                    var e = t.target;
    ...
    function Ft(i, n, s, o) {
        ...
        if (d && (e = (t = wt(n, i[0].ownerDocument, !1, i, o)).firstChild,
        ...
        e || o)) {
            ...
            if (a)
                ...
                h = 0; h < a; h++)
                    l = r[h],
                    ft.test(l.type || "") && !Q.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
        ...
        clone: function(t, e, i) {
            ...
            if (e)
                if (i)
                    ...
                    zt(t, h);
            return 0 < (r = gt(h, "script")).length && vt(r, !d && gt(t, "script")),
            h
        },
    ...
    function Zt(t, e, i) {
        ...
        return (i = i || Gt(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || ot(t) || (r = C.style(t, e)),
        !y.pixelBoxStyles() && Xt.test(r) && Ut.test(e) && (n = a.width,
        s = a.minWidth,
        o = a.maxWidth,
    ...
    (Vt = T.createElement("div")).style && (Vt.style.backgroundClip = "content-box",
    ...
    function ce(t, e, i, n, s, o) {
        ...
        for (; r < 4; r += 2)
            ...
            n ? ("content" === i && (l -= C.css(t, "padding" + nt[r], !0, s)),
            "margin" !== i && (l -= C.css(t, "border" + nt[r] + "Width", !0, s))) : (l += C.css(t, "padding" + nt[r], !0, s),
            "padding" !== i ? l += C.css(t, "border" + nt[r] + "Width", !0, s) : a += C.css(t, "border" + nt[r] + "Width", !0, s));
        return !n && 0 <= o && (l += Math.max(0, Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - o - l - a - .5)) || 0),
        l
    }
    function he(t, e, i) {
        var n = Gt(t)
          , s = (!y.boxSizingReliable() || i) && "border-box" === C.css(t, "boxSizing", !1, n)
          , o = s
          , r = Zt(t, e, n)
        ...
        return (!y.boxSizingReliable() && s || "auto" === r || !parseFloat(r) && "inline" === C.css(t, "display", !1, n)) && t.getClientRects().length && (s = "border-box" === C.css(t, "boxSizing", !1, n),
        (o = a in t) && (r = t[a])),
    ...
    C.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                "string" === (o = typeof i) && (s = it.exec(i)) && s[1] && (i = ct(t, e, s),
                o = "number"),
    ...
    C.each(["height", "width"], function(t, l) {
        C.cssHooks[l] = {
            get: function(t, e, i) {
                if (e)
                    return !se.test(C.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? he(t, l, i) : at(t, re, function() {
                        return he(t, l, i)
                    })
            },
            set: function(t, e, i) {
                var n, s = Gt(t), o = !y.scrollboxSize() && "absolute" === s.position, r = (o || i) && "border-box" === C.css(t, "boxSizing", !1, s), a = i ? ce(t, l, i, r, s) : 0;
                return r && o && (a -= Math.ceil(t["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(s[l]) - ce(t, l, "border", !1, s) - .5)),
                a && (n = it.exec(e)) && "px" !== (n[3] || "px") && (t.style[l] = e,
                e = C.css(t, l)),
                le(0, e, a)
            }
        }
    ...
    C.cssHooks.marginLeft = Jt(y.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(Zt(t, "marginLeft")) || t.getBoundingClientRect().left - at(t, {
                marginLeft: 0
            }, function() {
    ...
    function ye() {
        pe && (!1 === T.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(ye) : E.setTimeout(ye, C.fx.interval),
        C.fx.tick())
    }
    function be() {
    ...
    function we(t, e, i) {
        for (var n, s = (xe.tweeners[e] || []).concat(xe.tweeners["*"]), o = 0, r = s.length; o < r; o++)
            if (n = s[o].call(i, e, t))
                return n
    }
    function xe(o, t, e) {
        var i, r, n = 0, s = xe.prefilters.length, a = C.Deferred().always(function() {
            ...
            if (r)
                return !1;
            for (var t = ue || be(), e = Math.max(0, c.startTime + c.duration - t), i = 1 - (e / c.duration || 0), n = 0, s = c.tweens.length; n < s; n++)
                c.tweens[n].run(i);
            return a.notifyWith(o, [c, i, e]),
            i < 1 && s ? e : (s || a.notifyWith(o, [c, 1, 0]),
            a.resolveWith(o, [c]),
            !1)
        }, c = a.promise({
            elem: o,
        ...
        for (!function(t, e) {
            ...
            if (i = xe.prefilters[n].call(c, o, h, c.opts))
                return b(i.stop) && (C._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
                i;
        return C.map(h, we, c),
    ...
    C.Animation = C.extend(xe, {
        ...
        tweener: function(t, e) {
            ...
            ["*"]) : t.match(N)).length; n < s; n++)
                i = t[n],
                xe.tweeners[i] = xe.tweeners[i] || [],
                xe.tweeners[i].unshift(e)
        },
        prefilters: [function(t, e, i) {
            var n, s, o, r, a, l, c, h, d = "width"in e || "height"in e, u = this, p = {}, f = t.style, m = t.nodeType && lt(t), g = Q.get(t, "fxshow");
            ...
            if ((l = !C.isEmptyObject(e)) || !C.isEmptyObject(p))
                ...
                h = C.css(t, "display"),
                dt([t]))),
                ("inline" === h || "inline-block" === h && null != c) && "none" === C.css(t, "float") && (l || (u.done(function() {
                    f.display = c
                }),
                null == c && (h = f.display,
                c = "none" === h ? "" : h)),
    ...
    C.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === t.getAttribute ? C.prop(t, e, i) : (1 === o && C.isXMLDoc(t) || (s = C.attrHooks[e.toLowerCase()] || (C.expr.match.bool.test(e) ? Ee : void 0)),
        ...
        toggleClass: function(s, e) {
            ...
            return "boolean" == typeof e && r ? e ? this.addClass(s) : this.removeClass(s) : b(s) ? this.each(function(t) {
                ...
                if (r)
                    ...
                    void 0 !== s && "boolean" != o || ((t = Ie(this)) && Q.set(this, "__className__", t),
            ...
            select: {
                get: function(t) {
                    ...
                    for (n = o < 0 ? l : r ? o : 0; n < l; n++)
                        if (((i = s[n]).selected || n === o) && !i.disabled && (!i.parentNode.disabled || !I(i.parentNode, "optgroup"))) {
                            if (e = C(i).val(),
                            r)
                                return e;
                            a.push(e)
                ...
                set: function(t, e) {
                    for (var i, n, s = t.options, o = C.makeArray(e), r = s.length; r--; )
                        ((n = s[r]).selected = -1 < C.inArray(C.valHooks.option.get(n), o)) && (i = !0);
    ...
    C.extend(C.event, {
        trigger: function(t, e, i, n) {
            var s, o, r, a, l, c, h, d, u = [i || T], p = v.call(t, "type") ? t.type : t, f = v.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = d = r = i = i || T,
            3 !== i.nodeType && 8 !== i.nodeType && !Me.test(p + C.event.triggered) && (-1 < p.indexOf(".") && (p = (f = p.split(".")).shift(),
            f.sort()),
            l = p.indexOf(":") < 0 && "on" + p,
            ...
            n || !h.trigger || !1 !== h.trigger.apply(i, e))) {
                if (!n && !h.noBubble && !m(i)) {
                    ...
                    Me.test(a + p) || (o = o.parentNode); o; o = o.parentNode)
                        u.push(o),
                        r = o;
                ...
                return t.type = p,
                n || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(u.pop(), e) || !G(i) || l && b(i[p]) && !m(i) && ((r = i[l]) && (i[l] = null),
                C.event.triggered = p,
    ...
    y.focusin || C.each({
        ...
        C.event.special[n] = {
            ...
            teardown: function() {
                var t = this.ownerDocument || this
                  , e = Q.access(t, n) - 1;
                e ? Q.access(t, n, e) : (t.removeEventListener(i, s, !0),
                Q.remove(t, n))
            }
        }
    });
    ...
    C.extend({
        ...
        ajax: function(t, e) {
            ...
            t = void 0),
            e = e || {};
            var h, d, u, i, p, n, f, m, s, o, g = C.ajaxSetup({}, e), v = g.context || g, y = g.context && (v.nodeType || v.jquery) ? C(v) : C.event, b = C.Deferred(), _ = C.Callbacks("once memory"), w = g.statusCode || {}, r = {}, a = {}, l = "canceled", x = {
                readyState: 0,
            ...
            if (b.promise(x),
            g.url = ((t || g.url || Oe.href) + "").replace(Ve, Oe.protocol + "//"),
            ...
            d = g.url.replace(Re, ""),
            g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Be, "+")) : (o = g.url.slice(d.length),
            g.data && (g.processData || "string" == typeof g.data) && (d += ($e.test(d) ? "&" : "?") + g.data,
            delete g.data),
            !1 === g.cache && (d = d.replace(qe, "$1"),
            o = ($e.test(d) ? "&" : "?") + "_=" + Le++ + o),
            g.url = d + o),
            g.ifModified && (C.lastModified[d] && x.setRequestHeader("If-Modified-Since", C.lastModified[d]),
            ...
            x.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Ue + "; q=0.01" : "") : g.accepts["*"]),
            g.headers)
            ...
            function c(t, e, i, n) {
                ...
                s ? (g.ifModified && ((l = x.getResponseHeader("Last-Modified")) && (C.lastModified[d] = l),
                ...
                send: function(t, e) {
                    ...
                    o = function(t) {
                        return function() {
                            ...
                            "abort" === t ? n.abort() : "error" === t ? "number" != typeof n.status ? e(0, "error") : e(n.status, n.statusText) : e(ti[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? {
                                binary: n.response
                            } : {
                                text: n.responseText
    ...
    C.ajaxPrefilter("json jsonp", function(t, e, i) {
        var n, s, o, r = !1 !== t.jsonp && (si.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && si.test(t.data) && "data");
        if (r || "jsonp" === t.dataTypes[0])
            return n = t.jsonpCallback = b(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
            r ? t[r] = t[r].replace(si, "$1" + n) : !1 !== t.jsonp && (t.url += ($e.test(t.url) ? "&" : "?") + t.jsonp + "=" + n),
    ...
    y.createHTMLDocument = ((ii = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    C.parseHTML = function(t, e, i) {
        ...
        o = !i && [],
        (s = A.exec(t)) ? [e.createElement(s[1])] : (s = wt([t], e, o),
    ...
    C.offset = {
        setOffset: function(t, e, i) {
            ...
            o = C.css(t, "top"),
            l = C.css(t, "left"),
            s = ("absolute" === c || "fixed" === c) && -1 < (o + l).indexOf("auto") ? (r = (n = h.position()).top,
        ...
        C.each({
            ...
            C.fn[o] = function(t, e) {
                ...
                return q(this, function(t, e, i) {
                    ...
                    Math.max(t.body["scroll" + r], n["scroll" + r], t.body["offset" + r], n["offset" + r], n["client" + r])) : void 0 === i ? C.css(t, e, s) : C.style(t, e, i, s)
                }, a, i ? t : void 0, i)
            }
        })
    }),
...
function(t, e) {
    ...
    var M = "carousel"
      ...
      , at = function() {
        ...
        t.pause = function(t) {
            t || (this._isPaused = !0),
            this._element.querySelector(it) && (m.triggerTransitionEnd(this._element),
            this.cycle(!0)),
        ...
        t._slide = function(t, e) {
            var i, n, s, o = this, r = this._element.querySelector(J), a = this._getItemIndex(r), l = e || r && this._getItemByDirection(t, r), c = this._getItemIndex(l), h = Boolean(this._interval);
            if (s = t === H ? (i = G,
            n = U,
            B) : (i = X,
            n = Q,
            ...
            l && f(l).hasClass(Y))
                ...
                if (f(this._element).hasClass(V)) {
                    ...
                    u ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval,
                    ...
                    f(r).one(m.TRANSITION_END, function() {
                        f(l).removeClass(i + " " + n).addClass(Y),
    ...
    ;
    for (var Tt = "undefined" != typeof window && "undefined" != typeof document, Ct = ["Edge", "Trident", "Firefox"], St = 0, kt = 0; kt < Ct.length; kt += 1)
    ...
    function Nt(t) {
        ...
        for (var e = $t(10) ? document.body : null, i = t.offsetParent || null; i === e && t.nextElementSibling; )
    ...
    function se(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, i) {
            ...
            t.enabled && At(e) && (i.offsets.popper = Xt(i.offsets.popper),
    ...
    function le(t, e, i, n) {
        i.updateBound = n,
        ae(t).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        var s = Mt(t);
    ...
    function ce() {
        ...
        this.state = function(t, e) {
            return ae(t).removeEventListener("resize", e.updateBound),
    ...
    function de(i, n) {
        Object.keys(n).forEach(function(t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && he(n[t]) && (e = "px"),
            i.style[t] = n[t] + e
        })
    }
        ...
        modifiers: {
                ...
                fn: function(t, n) {
                    ...
                    var c = n.priority
                      ...
                      , d = {
                        primary: function(t) {
                            var e = h[t];
                            return h[t] < l[t] && !n.escapeWithReference && (e = Math.max(h[t], l[t])),
                            Yt({}, t, e)
                        },
                        secondary: function(t) {
                            var e = "right" === t ? "left" : "top"
                              , i = h[e];
                            return h[t] > l[t] && !n.escapeWithReference && (i = Math.min(h[e], l[t] - ("right" === t ? h.width : h.height))),
                            Yt({}, e, i)
                        }
                    };
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    t.arrowElement = n,
                    t.offsets.arrow = (Yt(i = {}, d, Math.round(b)),
                    Yt(i, u, ""),
                    i),
                    t
                },
            ...
            flip: {
                ...
                fn: function(p, f) {
                    ...
                    return b.forEach(function(t, e) {
                        ...
                        p.placement = g + (y ? "-" + y : ""),
                        p.offsets.popper = Vt({}, p.offsets.popper, ie(p.instance.popper, p.offsets.reference, p.placement)),
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var r = void 0 !== o ? o : e.gpuAcceleration
                      ...
                      , f = void 0
                      , m = void 0;
                    if (m = "bottom" == d ? "HTML" === a.nodeName ? -a.clientHeight + h.bottom : -l.height + h.bottom : h.top,
                    ...
                    return t.attributes = Vt({}, y, t.attributes),
    ...
    function Ee(t, e) {
        ...
        Object.keys(Vt({}, Ee.Defaults.modifiers, n.modifiers)).forEach(function(t) {
      ...
      , Ke = function() {
                ...
                !e) {
                    ...
                    !n.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            "scrollParent" !== this._config.boundary && f(t).addClass(ze),
                            this._popper = new xe(s,this._menu,this._getPopperConfig())
                        }
                        "ontouchstart"in document.documentElement && 0 === f(t).closest(Be).length && f(document.body).children().on("mouseover", null, f.noop),
                        this._element.focus(),
        ...
        t.show = function() {
            if (!(this._element.disabled || f(this._element).hasClass(Pe) || f(this._menu).hasClass(Me))) {
                ...
                f(i).trigger(e),
                e.isDefaultPrevented() || (f(this._menu).toggleClass(Me),
        ...
        t._getPlacement = function() {
            var t = f(this._element.parentNode)
              , e = Ye;
            return t.hasClass(Oe) ? (e = qe,
            f(this._menu).hasClass(Ne) && (e = We)) : t.hasClass(Le) ? e = Xe : t.hasClass($e) ? e = Ge : f(this._menu).hasClass(Ne) && (e = Ve),
            e
        }
        ,
        ...
        c._clearMenus = function(t) {
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                for (var e = [].slice.call(document.querySelectorAll(Fe)), i = 0, n = e.length; i < n; i++) {
        ...
        c._dataApiKeydownHandler = function(t) {
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || f(t.target).closest(je).length)) : Ae.test(t.which)) && (t.preventDefault(),
            t.stopPropagation(),
    ...
    var Ze = "modal"
      ...
      , vi = function() {
        ...
        t._showElement = function(t) {
            ...
            f(this._dialog).hasClass(oi) ? this._dialog.querySelector(ui).scrollTop = 0 : this._element.scrollTop = 0,
        ...
        s._jQueryInterface = function(i, n) {
            return this.each(function() {
                var t = f(this).data(Je)
                  , e = l({}, ii, f(this).data(), "object" == typeof i && i ? i : {});
                if (t || (t = new s(this,e),
                f(this).data(Je, t)),
                "string" == typeof i) {
                    if (void 0 === t[i])
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(r), l = [].slice.call(i.body.querySelectorAll("*")), n = function(t, e) {
            ...
            s.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(i))
                        return -1 === yi.indexOf(i) || Boolean(t.nodeValue.match(_i) || t.nodeValue.match(wi));
    ...
    var Ei = "tooltip"
      ...
      , Wi = function() {
        ...
        t.setElementContent = function(t, e) {
            "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = xi(e, this.config.whiteList, this.config.sanitizeFn)),
        ...
        t._enter = function(t, e) {
            ...
            f(e.getTipElement()).hasClass(zi) || e._hoverState === Oi ? e._hoverState = Oi : (clearTimeout(e._timeout),
            e._hoverState = Oi,
        ...
        t._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (f(t).removeClass(Ni),
    ...
    var rn = "scrollspy"
      ...
      , Cn = function() {
        function i(t, e) {
            ...
            this._config = this._getConfig(e),
            this._selector = this._config.target + " " + vn + "," + this._config.target + " " + bn + "," + this._config.target + " " + wn,
            this._offsets = [],
            this._targets = [],
        ...
        t._getConfig = function(t) {
            ...
            return m.typeCheckConfig(rn, t, dn),
            t
        }
        ,
        ...
        t._activate = function(e) {
            ...
            i.hasClass(pn) ? (i.closest(_n).find(xn).addClass(fn),
            i.addClass(fn)) : (i.addClass(fn),
            i.parents(gn).prev(vn + ", " + bn).addClass(fn),
            i.parents(gn).prev(yn).children(vn).addClass(fn)),
            f(this._scrollElement).trigger(un.ACTIVATE, {
                relatedTarget: e
            })
        }
        ,
    ...
    var Sn = "bs.tab"
      ...
      , Rn = function() {
        ...
        t._activate = function(t, e, i) {
            ...
            var s = this
              , o = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? f(e).children(zn) : f(e).find(Fn))[0]
    ...
    f(document).on(An.CLICK_DATA_API, Hn, function(t) {
        t.preventDefault(),
        Rn._jQueryInterface.call(f(this), "show")
    }),
    ...
    var qn = "toast"
      ...
      , es = function() {
        ...
        t.hide = function(t) {
            var e = this;
            this._element.classList.contains(Qn) && (f(this._element).trigger(Xn.HIDE),
        ...
        ,
        t._getConfig = function(t) {
            return t = l({}, Jn, f(this._element).data(), "object" == typeof t && t ? t : {}),
        ...
        t._close = function() {
            function t() {
                ...
                f(e._element).trigger(Xn.HIDDEN)
            }
            var e = this;
        ...
        n._jQueryInterface = function(i) {
            return this.each(function() {
                var t = f(this)
                  , e = t.data(Wn);
                if (e || (e = new n(this,"object" == typeof i && i),
                t.data(Wn, e)),
                "string" == typeof i) {
                    if (void 0 === e[i])
                        throw new TypeError('No method named "' + i + '"');
...
function(l, i, s, a) {
    ...
    c.prototype.register = function(i) {
        if (i.type === c.Type.Event) {
            ...
            i.type === c.Type.State && (this._states.tags[i.name] ? this._states.tags[i.name] = this._states.tags[i.name].concat(i.tags) : this._states.tags[i.name] = i.tags,
...
function(s, t, e, o) {
    ...
    d() && (s.support.animation = new String(n("animation")),
    s.support.animation.end = l.animation.end[s.support.animation]),
    c() && (s.support.transform = new String(n("transform")),
...
function(t, e) {
        ...
        if (t)
            if ("string" == typeof t) {
                ...
                if (0 <= r.indexOf("<") && 0 <= r.indexOf(">")) {
                    ...
                    for (s = e || "#" !== t[0] || t.match(/[ .<>:~]/) ? (e || m).querySelectorAll(t.trim()) : [m.getElementById(t.trim().split("#")[1])],
                    n = 0; n < s.length; n += 1)
                        s[n] && i.push(s[n])
    ...
    var e = {
        ...
        off: function() {
            ...
            for (var a = n.split(" "), l = 0; l < a.length; l += 1)
                for (var c = a[l], h = 0; h < this.length; h += 1) {
                    var d = this[h]
                      , u = void 0;
                    if (!s && d.dom7Listeners ? u = d.dom7Listeners[c] : s && d.dom7LiveListeners && (u = d.dom7LiveListeners[c]),
                    u && u.length)
                        for (var p = u.length - 1; 0 <= p; p -= 1) {
                            var f = u[p];
                            o && f.listener === o ? (d.removeEventListener(c, f.proxyListener, r),
                            u.splice(p, 1)) : o && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === o ? (d.removeEventListener(c, f.proxyListener, r),
                            u.splice(p, 1)) : o || (d.removeEventListener(c, f.proxyListener, r),
                            u.splice(p, 1))
                        }
                }
            return this
            ...
            for (var i = t[0].split(" "), n = t[1], s = 0; s < i.length; s += 1)
                for (var o = i[s], r = 0; r < this.length; r += 1) {
                    ...
                    try {
                        ...
                        (l = m.createEvent("Event")).initEvent(o, !0, !0),
                        l.detail = n
                    }
        ...
        parent: function(t) {
            for (var e = [], i = 0; i < this.length; i += 1)
                null !== this[i].parentNode && (t ? P(this[i].parentNode).is(t) && e.push(this[i].parentNode) : e.push(this[i].parentNode));
            return P(o(e))
        },
        parents: function(t) {
            for (var e = [], i = 0; i < this.length; i += 1)
        ...
        children: function(t) {
            for (var e = [], i = 0; i < this.length; i += 1)
                for (var n = this[i].childNodes, s = 0; s < n.length; s += 1)
                    t ? 1 === n[s].nodeType && P(n[s]).is(t) && e.push(n[s]) : 1 === n[s].nodeType && e.push(n[s]);
            return new l(o(e))
        },
        remove: function() {
    ...
    var i, n, s, r, tt = {
        ...
        getTranslate: function(t, e) {
            ...
            s = new J.WebKitCSSMatrix("none" === n ? "" : n)) : i = (s = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
            "x" === e && (n = J.WebKitCSSMatrix ? s.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])),
            "y" === e && (n = J.WebKitCSSMatrix ? s.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])),
            n || 0
        },
        parseUrlQuery: function(t) {
            var e, i, n, s, o = {}, r = t || J.location.href;
            if ("string" == typeof r && r.length)
                for (s = (i = (r = -1 < r.indexOf("?") ? r.replace(/\S*\?/, "") : "").split("&").filter(function(t) {
                    return "" !== t
                })).length,
                e = 0; e < s; e += 1)
            ...
            for (var i = Object(t[0]), n = 1; n < t.length; n += 1) {
                ...
                if (null != s)
                    for (var o = Object.keys(Object(s)), r = 0, a = o.length; r < a; r += 1) {
                        ...
                        void 0 !== c && c.enumerable && (tt.isObject(i[l]) && tt.isObject(s[l]) ? tt.extend(i[l], s[l]) : !tt.isObject(i[l]) && tt.isObject(s[l]) ? (i[l] = {},
                        tt.extend(i[l], s[l])) : i[l] = s[l])
                    }
            }
            return i
        }
    }, et = (s = m.createElement("div"),
    {
        ...
        transition: (n = s.style,
        "transition"in n || "webkitTransition"in n || "MozTransition"in n),
        transforms3d: J.Modernizr && !0 === J.Modernizr.csstransforms3d || (i = s.style,
        ...
        isSafari: (r = J.navigator.userAgent.toLowerCase(),
    ...
    t.prototype.emit = function() {
        for (var t = [], e = arguments.length; e--; )
            t[e] = arguments[e];
        var i, n, s, o = this;
        return o.eventsListeners && (s = "string" == typeof t[0] || Array.isArray(t[0]) ? (i = t[0],
    ...
    var c = {
        ...
        updateSlides: function() {
            ...
            if (void 0 !== n) {
                ...
                1 < e.slidesPerColumn && (w = Math.floor(c / e.slidesPerColumn) === c / t.params.slidesPerColumn ? c : Math.ceil(c / e.slidesPerColumn) * e.slidesPerColumn,
                ...
                for (var E, T = e.slidesPerColumn, C = w / T, S = Math.floor(c / e.slidesPerColumn), k = 0; k < c; k += 1) {
                    ...
                    if (1 < e.slidesPerColumn) {
                        var A = void 0
                          , D = void 0
                          , P = void 0;
                        "column" === e.slidesPerColumnFill ? (P = k - (D = Math.floor(k / T)) * T,
                        (S < D || D === S && P === T - 1) && T <= (P += 1) && (P = 0,
                        D += 1),
                        A = D + P * w / T,
                        I.css({
                        ...
                        I.css("margin-" + (t.isHorizontal() ? "top" : "left"), 0 !== P && e.spaceBetween && e.spaceBetween + "px").attr("data-swiper-column", D).attr("data-swiper-row", P)
                    }
                    if ("none" !== I.css("display")) {
                        if ("auto" === e.slidesPerView) {
                            ...
                            e.roundLengths && (x = Math.floor(x)),
                            l[k] && (t.isHorizontal() ? l[k].style.width = x + "px" : l[k].style.height = x + "px");
                        l[k] && (l[k].swiperSlideSize = x),
                        u.push(x),
                        e.centeredSlides ? (y = y + x / 2 + b / 2 + v,
                        0 === b && 0 !== k && (y = y - n / 2 - v),
                        0 === k && (y = y - n / 2 - v),
                        Math.abs(y) < .001 && (y = 0),
                        e.roundLengths && (y = Math.floor(y)),
                        _ % e.slidesPerGroup == 0 && h.push(y),
                        d.push(y)) : (e.roundLengths && (y = Math.floor(y)),
                        _ % e.slidesPerGroup == 0 && h.push(y),
                        d.push(y),
                        y = y + x + v),
                        t.virtualSize += x + v,
                ...
                if (t.virtualSize = Math.max(t.virtualSize, n) + f,
                s && o && ("slide" === e.effect || "coverflow" === e.effect) && i.css({
                ...
                1 < e.slidesPerColumn && (t.virtualSize = (x + e.spaceBetween) * w,
                ...
                if (!e.centeredSlides) {
                    ...
                    h = E,
                    1 < Math.floor(t.virtualSize - n) - Math.floor(h[h.length - 1]) && h.push(t.virtualSize - n)
                }
                if (0 === h.length && (h = [0]),
                0 !== e.spaceBetween && (t.isHorizontal() ? s ? l.css({
                    marginLeft: v + "px"
                }) : l.css({
                    marginRight: v + "px"
                }) : l.css({
                ...
                h.length !== m && (t.params.watchOverflow && t.checkOverflow(),
            ...
            if (0 !== n.length) {
                ...
                for (var r = 0; r < n.length; r += 1) {
                    ...
                    if (i.watchSlidesVisibility) {
                        ...
                        (0 <= c && c < e.size || 0 < h && h <= e.size || c <= 0 && h >= e.size) && (e.visibleSlides.push(a),
        ...
        updateProgress: function(t) {
            ...
            var e = this
              ...
              , a = o
              , l = r;
            r = 0 == n ? o = !(s = 0) : (o = (s = (t - e.minTranslate()) / n) <= 0,
            1 <= s),
            tt.extend(e, {
                progress: s,
                isBeginning: o,
        ...
        updateSlidesClasses: function() {
            var t, e = this.slides, i = this.params, n = this.$wrapperEl, s = this.activeIndex, o = this.realIndex, r = this.virtual && i.virtual.enabled;
            ...
            i.loop && (t.hasClass(i.slideDuplicateClass) ? n.children("." + i.slideClass + ":not(." + i.slideDuplicateClass + ')[data-swiper-slide-index="' + o + '"]').addClass(i.slideDuplicateActiveClass) : n.children("." + i.slideClass + "." + i.slideDuplicateClass + '[data-swiper-slide-index="' + o + '"]').addClass(i.slideDuplicateActiveClass));
        ...
        updateActiveIndex: function(t) {
            var e, i = this, n = i.rtlTranslate ? i.translate : -i.translate, s = i.slidesGrid, o = i.snapGrid, r = i.params, a = i.activeIndex, l = i.realIndex, c = i.snapIndex, h = t;
            if (void 0 === h) {
                for (var d = 0; d < s.length; d += 1)
                    void 0 !== s[d + 1] ? n >= s[d] && n < s[d + 1] - (s[d + 1] - s[d]) / 2 ? h = d : n >= s[d] && n < s[d + 1] && (h = d + 1) : n >= s[d] && (h = d);
                r.normalizeSlideIndex && (h < 0 || void 0 === h) && (h = 0)
            }
            if ((e = 0 <= o.indexOf(n) ? o.indexOf(n) : Math.floor(h / r.slidesPerGroup)) >= o.length && (e = o.length - 1),
            h !== a) {
        ...
        updateClickedSlide: function(t) {
            ...
            e.clickedSlide = n,
            e.virtual && e.params.virtual.enabled ? e.clickedIndex = parseInt(P(n).attr("data-swiper-slide-index"), 10) : e.clickedIndex = P(n).index(),
      ...
      , h = {
        ...
        setTranslate: function(t, e) {
            ...
            l = Math.floor(l)),
            s.virtualTranslate || (et.transforms3d ? o.transform("translate3d(" + a + "px, " + l + "px, 0px)") : o.transform("translate(" + a + "px, " + l + "px)")),
            i.previousTranslate = i.translate,
            i.translate = i.isHorizontal() ? a : l;
            var c = i.maxTranslate() - i.minTranslate();
            (0 == c ? 0 : (t - i.minTranslate()) / c) !== r && i.updateProgress(t),
      ...
      , d = {
        slideTo: function(t, e, i, n) {
            ...
            (h || r.initialSlide || 0) === (c || 0) && i && s.emit("beforeSlideChangeStart");
            var p, f = -a[u];
            ...
            if (s.initialized && o !== h) {
                if (!s.allowSlideNext && f < s.translate && f < s.minTranslate())
                    return !1;
                if (!s.allowSlidePrev && f > s.translate && f > s.maxTranslate() && (h || 0) !== o)
                    return !1
            }
            return p = h < o ? "next" : o < h ? "prev" : "reset",
            d && -f === s.translate || !d && f === s.translate ? (s.updateActiveIndex(o),
            r.autoHeight && s.updateAutoHeight(),
            s.updateSlidesClasses(),
            "slide" !== r.effect && s.setTranslate(f),
            "reset" != p && (s.transitionStart(i, p),
            s.transitionEnd(i, p)),
            !1) : (0 !== e && et.transition ? (s.setTransition(e),
            s.setTranslate(f),
        ...
        slideToClickedSlide: function() {
            var t, e = this, i = e.params, n = e.$wrapperEl, s = "auto" === i.slidesPerView ? e.slidesPerViewDynamic() : i.slidesPerView, o = e.clickedIndex;
            if (i.loop) {
                if (e.animating)
                    return;
                t = parseInt(P(e.clickedSlide).attr("data-swiper-slide-index"), 10),
                i.centeredSlides ? o < e.loopedSlides - s / 2 || o > e.slides.length - e.loopedSlides + s / 2 ? (e.loopFix(),
                o = n.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(),
      ...
      , u = {
        ...
        loopFix: function() {
            var t, e = this, i = e.params, n = e.activeIndex, s = e.slides, o = e.loopedSlides, r = e.allowSlidePrev, a = e.allowSlideNext, l = e.snapGrid, c = e.rtlTranslate;
            e.allowSlidePrev = !0,
            e.allowSlideNext = !0;
            var h = -l[n] - e.getTranslate();
            n < o ? (t = s.length - 3 * o + n,
            t += o,
            e.slideTo(t, 0, !1, !0) && 0 != h && e.setTranslate((c ? -e.translate : e.translate) - h)) : ("auto" === i.slidesPerView && 2 * o <= n || n >= s.length - o) && (t = -s.length + n + o,
            t += o,
            e.slideTo(t, 0, !1, !0) && 0 != h && e.setTranslate((c ? -e.translate : e.translate) - h)),
            e.allowSlidePrev = r,
            e.allowSlideNext = a
        },
      ...
      , g = function() {
        ...
        (s || r || o) && (e.os = "ios",
        e.ios = !0),
        r && !o && (e.osVersion = r[2].replace(/_/g, "."),
        e.iphone = !0),
    ...
    var y = {
      ...
      , b = {
        ...
        transition: {
            ...
            transitionStart: function(t, e) {
                ...
                var o = e;
                if (o = o || (s < i ? "next" : i < s ? "prev" : "reset"),
            ...
            transitionEnd: function(t, e) {
                ...
                var s = e;
                if (s = s || (n < i ? "next" : i < n ? "prev" : "reset"),
        ...
        events: {
            attachEvents: function() {
                ...
                t.onTouchStart = function(t) {
                    ...
                    if (!e.animating || !n.preventInteractionOnTransition) {
                        ...
                        (i.isTouchEvent || !("which"in o) || 3 !== o.which) && !(!i.isTouchEvent && "button"in o && 0 < o.button || i.isTouched && i.isMoved))
                            if (n.noSwiping && P(o.target).closest(n.noSwipingSelector ? n.noSwipingSelector : "." + n.noSwipingClass)[0])
                                e.allowClick = !0;
                                ...
                                if (!l || !(r <= c || r >= J.screen.width - c)) {
                                    ...
                                    "touchstart" !== o.type) {
                                        ...
                                        m.activeElement && P(m.activeElement).is(i.formElements) && m.activeElement !== o.target && m.activeElement.blur();
                    ...
                    i.isTouched) {
                        if (!i.isTouchEvent || "mousemove" !== r.type) {
                            ...
                            if (i.isTouchEvent && n.touchReleaseOnEdges && !n.loop)
                                if (e.isVertical()) {
                                    if (l < s.startY && e.translate <= e.maxTranslate() || l > s.startY && e.translate >= e.minTranslate())
                                        return i.isTouched = !1,
                                        void (i.isMoved = !1)
                                } else if (a < s.startX && e.translate <= e.maxTranslate() || a > s.startX && e.translate >= e.minTranslate())
                                    return;
                            if (i.isTouchEvent && m.activeElement && r.target === m.activeElement && P(r.target).is(i.formElements))
                                return i.isMoved = !0,
                                void (e.allowClick = !1);
                            if (i.allowTouchCallbacks && e.emit("touchMove", r),
                            !(r.targetTouches && 1 < r.targetTouches.length)) {
                                ...
                                if (!(e.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(d, 2)) < e.params.threshold))
                                    if (void 0 === i.isScrolling && (e.isHorizontal() && s.currentY === s.startY || e.isVertical() && s.currentX === s.startX ? i.isScrolling = !1 : 25 <= h * h + d * d && (c = 180 * Math.atan2(Math.abs(d), Math.abs(h)) / Math.PI,
                                    i.isScrolling = e.isHorizontal() ? c > n.touchAngle : 90 - c > n.touchAngle)),
                                    ...
                                    i.isScrolling)
                                        ...
                                        n.resistance && (i.currentTranslate = e.minTranslate() - 1 + Math.pow(-e.minTranslate() + i.startTranslate + u, f))) : u < 0 && i.currentTranslate < e.maxTranslate() && (p = !1,
                                        n.resistance && (i.currentTranslate = e.maxTranslate() + 1 - Math.pow(e.maxTranslate() - i.startTranslate - u, f))),
                                        ...
                                        0 < n.threshold) {
                                            ...
                                            if (!i.allowThresholdMove)
                                                ...
                                                void (s.diff = e.isHorizontal() ? s.currentX - s.startX : s.currentY - s.startY)
                                        }
                                        n.followFinger && ((n.freeMode || n.watchSlidesProgress || n.watchSlidesVisibility) && (e.updateActiveIndex(),
                        ...
                        i.startMoving && i.isScrolling && e.emit("touchMoveOpposite", r)
                }
                .bind(t),
                t.onTouchEnd = function(t) {
                    ...
                    i.isMoved = !1,
                    i.startMoving = !1,
                    h = n.followFinger ? o ? e.translate : -e.translate : -i.currentTranslate,
                    n.freeMode) {
                        if (h < -e.minTranslate())
                        ...
                        if (n.freeModeMomentum) {
                            ...
                            if (b < e.maxTranslate())
                                n.freeModeMomentumBounce ? (b + e.maxTranslate() < -E && (b = e.maxTranslate() - E),
                                _ = e.maxTranslate(),
                                x = !0,
                                i.allowMomentumBounce = !0) : b = e.maxTranslate(),
                                n.loop && n.centeredSlides && (w = !0);
                            else if (b > e.minTranslate())
                                n.freeModeMomentumBounce ? (b - e.minTranslate() > E && (b = e.minTranslate() + E),
                                _ = e.minTranslate(),
                                x = !0,
                            ...
                            0 !== e.velocity)
                                v = o ? Math.abs((-b - e.translate) / e.velocity) : Math.abs((b - e.translate) / e.velocity);
                            else if (n.freeModeSticky)
                                return void e.slideToClosest();
                            n.freeModeMomentumBounce && x ? (e.updateProgress(_),
                            e.setTransition(v),
                            e.setTranslate(b),
                            ...
                            return void e.slideToClosest();
                        (!n.freeModeMomentum || u >= n.longSwipesMs) && (e.updateProgress(),
                        e.updateActiveIndex(),
                        e.updateSlidesClasses())
                    } else {
                        for (var S = 0, k = e.slidesSizesGrid[0], I = 0; I < a.length; I += n.slidesPerGroup)
                            void 0 !== a[I + n.slidesPerGroup] ? h >= a[I] && h < a[I + n.slidesPerGroup] && (k = a[(S = I) + n.slidesPerGroup] - a[I]) : h >= a[I] && (S = I,
                            k = a[a.length - 1] - a[a.length - 2]);
                        var A = (h - a[S]) / k;
                        if (u > n.longSwipesMs) {
                            if (!n.longSwipes)
                                return void e.slideTo(e.activeIndex);
                            "next" === e.swipeDirection && (A >= n.longSwipesRatio ? e.slideTo(S + n.slidesPerGroup) : e.slideTo(S)),
                            "prev" === e.swipeDirection && (A > 1 - n.longSwipesRatio ? e.slideTo(S + n.slidesPerGroup) : e.slideTo(S))
                        } else {
                            if (!n.shortSwipes)
                                return void e.slideTo(e.activeIndex);
                ...
                if (et.touch || !et.pointerEvents && !et.prefixedPointerEvents) {
                    if (et.touch) {
                        ...
                        o.addEventListener(i.move, t.onTouchMove, et.passiveListener ? {
                            passive: !1,
                            capture: r
                        } : r),
                        o.addEventListener(i.end, t.onTouchEnd, a)
                    }
                    (e.simulateTouch && !g.ios && !g.android || e.simulateTouch && !et.touch && g.ios) && (o.addEventListener("mousedown", t.onTouchStart, !1),
            ...
            detachEvents: function() {
                ...
                if (et.touch || !et.pointerEvents && !et.prefixedPointerEvents) {
                    ...
                    (e.simulateTouch && !g.ios && !g.android || e.simulateTouch && !et.touch && g.ios) && (o.removeEventListener("mousedown", t.onTouchStart, !1),
        ...
        classes: {
            addClasses: function() {
                ...
                g.ios && s.push("ios"),
                (M.isIE || M.isEdge) && (et.pointerEvents || et.prefixedPointerEvents) && s.push("wp8-" + i.direction),
                s.forEach(function(t) {
        ...
        images: {
            loadImage: function(t, e, i, n, s, o) {
                ...
                t.complete && s ? a() : e ? ((r = new J.Image).onload = a,
                r.onerror = a,
                n && (r.sizes = n),
                i && (r.srcset = i),
                e && (r.src = e)) : a()
      ...
      , w = function(u) {
        function p() {
            for (var t, e, s, i = [], n = arguments.length; n--; )
                i[n] = arguments[n];
            s = (s = 1 === i.length && i[0].constructor && i[0].constructor === Object ? i[0] : (e = (t = i)[0],
            t[1])) || {},
            s = tt.extend({}, s),
            e && !s.el && (s.el = e),
            u.call(this, s),
            ...
            if (e = a[0]) {
                ...
                return tt.extend(o, {
                    ...
                    touchEvents: (c = ["touchstart", "touchmove", "touchend"],
                    h = ["mousedown", "mousemove", "mouseup"],
                    et.pointerEvents ? h = ["pointerdown", "pointermove", "pointerup"] : et.prefixedPointerEvents && (h = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]),
                    o.touchEventsTouch = {
                        start: c[0],
                        move: c[1],
                        end: c[2]
        ...
        return ((p.prototype = Object.create(u && u.prototype)).constructor = p).prototype.slidesPerViewDynamic = function() {
            var t = this.params
              ...
              , o = 1;
            if (t.centeredSlides) {
                for (var r, a = e[s].swiperSlideSize, l = s + 1; l < e.length; l += 1)
                    e[l] && !r && (o += 1,
                    n < (a += e[l].swiperSlideSize) && (r = !0));
                for (var c = s - 1; 0 <= c; c -= 1)
                    e[c] && !r && (o += 1,
                    n < (a += e[c].swiperSlideSize) && (r = !0))
            } else
        ...
        p.prototype.changeDirection = function(i, t) {
            ...
            return (i = i || ("horizontal" === n ? "vertical" : "horizontal")) === n || "horizontal" !== i && "vertical" !== i || ("vertical" === n && (e.$el.removeClass(e.params.containerModifierClass + "vertical wp8-vertical").addClass("" + e.params.containerModifierClass + i),
            (M.isIE || M.isEdge) && (et.pointerEvents || et.prefixedPointerEvents) && e.$el.addClass(e.params.containerModifierClass + "wp8-" + i)),
            "horizontal" === n && (e.$el.removeClass(e.params.containerModifierClass + "horizontal wp8-horizontal").addClass("" + e.params.containerModifierClass + i),
            (M.isIE || M.isEdge) && (et.pointerEvents || et.prefixedPointerEvents) && e.$el.addClass(e.params.containerModifierClass + "wp8-" + i)),
      ...
      , I = {
        update: function(t) {
            ...
            if (t)
                ...
                for (var S = h; S <= d; S += 1)
                    (S < _ || w < S) && e.$wrapperEl.find("." + e.params.slideClass + '[data-swiper-slide-index="' + S + '"]').remove();
            for (var k = 0; k < u.length; k += 1)
                _ <= k && k <= w && (void 0 === d || t ? C.push(k) : (d < k && C.push(k),
                k < h && T.push(k)));
      ...
      , D = {
        handle: function(t) {
            ...
            if (!e.allowSlideNext && (e.isHorizontal() && 39 === s || e.isVertical() && 40 === s))
                return !1;
            if (!e.allowSlidePrev && (e.isHorizontal() && 37 === s || e.isVertical() && 38 === s))
                return !1;
            if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || m.activeElement && m.activeElement.nodeName && ("input" === m.activeElement.nodeName.toLowerCase() || "textarea" === m.activeElement.nodeName.toLowerCase()))) {
                ...
                e.isHorizontal() ? (37 !== s && 39 !== s || (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                (39 === s && !i || 37 === s && i) && e.slideNext(),
                (37 === s && !i || 39 === s && i) && e.slidePrev()) : (38 !== s && 40 !== s || (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                40 === s && e.slideNext(),
                38 === s && e.slidePrev()),
                e.emit("keyPress", s)
            }
        ...
        enable: function() {
            this.keyboard.enabled || (P(m).on("keydown", this.keyboard.handle),
            this.keyboard.enabled = !0)
        },
        disable: function() {
            this.keyboard.enabled && (P(m).off("keydown", this.keyboard.handle),
      ...
      , L = {
        ...
        handle: function(t) {
            ...
            if (n.forceToAxis)
                ...
                s = Math.abs(r.pixelX) > Math.abs(r.pixelY) ? -r.pixelX * o : -r.pixelY;
            if (0 === s)
                return !0;
            if (n.invert && (s = -s),
            i.params.freeMode) {
        ...
        enable: function() {
            ...
            if (this.mousewheel.enabled)
                return !1;
            var t = this.$el;
            return "container" !== this.params.mousewheel.eventsTarged && (t = P(this.params.mousewheel.eventsTarged)),
      ...
      , $ = {
        update: function() {
            ...
            if (!this.params.loop) {
                var e = this.navigation
                  , i = e.$nextEl
                  , n = e.$prevEl;
                n && 0 < n.length && (this.isBeginning ? n.addClass(t.disabledClass) : n.removeClass(t.disabledClass),
        ...
        init: function() {
            ...
            (n.nextEl || n.prevEl) && (n.nextEl && (t = P(n.nextEl),
            i.params.uniqueNavElements && "string" == typeof n.nextEl && 1 < t.length && 1 === i.$el.find(n.nextEl).length && (t = i.$el.find(n.nextEl))),
            n.prevEl && (e = P(n.prevEl),
            i.params.uniqueNavElements && "string" == typeof n.prevEl && 1 < e.length && 1 === i.$el.find(n.prevEl).length && (e = i.$el.find(n.prevEl))),
      ...
      , N = {
        update: function() {
            ...
            if (s.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                var o, i = t.virtual && t.params.virtual.enabled ? t.virtual.slides.length : t.slides.length, n = t.pagination.$el, r = t.params.loop ? Math.ceil((i - 2 * t.loopedSlides) / t.params.slidesPerGroup) : t.snapGrid.length;
                if (t.params.loop ? ((o = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup)) > i - 1 - 2 * t.loopedSlides && (o -= i - 2 * t.loopedSlides),
                r - 1 < o && (o -= r),
                o < 0 && "bullets" !== t.params.paginationType && (o = r + o)) : o = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0,
                "bullets" === s.type && t.pagination.bullets && 0 < t.pagination.bullets.length) {
                    var a, l, c, h = t.pagination.bullets;
                    if (s.dynamicBullets && (t.pagination.bulletSize = h.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                    n.css(t.isHorizontal() ? "width" : "height", t.pagination.bulletSize * (s.dynamicMainBullets + 4) + "px"),
                    1 < s.dynamicMainBullets && void 0 !== t.previousIndex && (t.pagination.dynamicBulletIndex += o - t.previousIndex,
                    ...
                    c = ((l = a + (Math.min(h.length, s.dynamicMainBullets) - 1)) + a) / 2),
                    ...
                    else if (h.eq(o).addClass(s.bulletActiveClass),
                    s.dynamicBullets) {
                        for (var d = h.eq(a), u = h.eq(l), p = a; p <= l; p += 1)
                            h.eq(p).addClass(s.bulletActiveClass + "-main");
                        d.prev().addClass(s.bulletActiveClass + "-prev").prev().addClass(s.bulletActiveClass + "-prev-prev"),
                ...
                "progressbar" === s.type) {
                    ...
                    n.find("." + s.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + b + ") scaleY(" + _ + ")").transition(t.params.speed)
                }
                "custom" === s.type && s.renderCustom ? (n.html(s.renderCustom(t, o + 1, r)),
        ...
        render: function() {
            ...
            if (e.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                var i = t.virtual && t.params.virtual.enabled ? t.virtual.slides.length : t.slides.length
                  ...
                  , s = "";
                if ("bullets" === e.type) {
                    for (var o = t.params.loop ? Math.ceil((i - 2 * t.loopedSlides) / t.params.slidesPerGroup) : t.snapGrid.length, r = 0; r < o; r += 1)
                        e.renderBullet ? s += e.renderBullet.call(t, r, e.bulletClass) : s += "<" + e.bulletElement + ' class="' + e.bulletClass + '"></' + e.bulletElement + ">";
                    n.html(s),
      ...
      , z = {
        setTranslate: function() {
            if (this.params.scrollbar.el && this.scrollbar.el) {
                ...
                c = 0) : s < c + n && (l = s - c),
                this.isHorizontal() ? (et.transforms3d ? o.transform("translate3d(" + c + "px, 0, 0)") : o.transform("translateX(" + c + "px)"),
                o[0].style.width = l + "px") : (et.transforms3d ? o.transform("translate3d(0px, " + c + "px, 0)") : o.transform("translateY(" + c + "px)"),
        ...
        updateSize: function() {
            ...
            if (t.params.scrollbar.el && t.scrollbar.el) {
                ...
                i[0].style.width = "",
                i[0].style.height = "";
                var s, o = t.isHorizontal() ? n[0].offsetWidth : n[0].offsetHeight, r = t.size / t.virtualSize, a = r * (o / t.size);
                s = "auto" === t.params.scrollbar.dragSize ? o * r : parseInt(t.params.scrollbar.dragSize, 10),
                t.isHorizontal() ? i[0].style.width = s + "px" : i[0].style.height = s + "px",
        ...
        setDragPosition: function(t) {
            ...
            e = ((i.isHorizontal() ? "touchstart" === t.type || "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX || t.clientX : "touchstart" === t.type || "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY || t.clientY) - o.offset()[i.isHorizontal() ? "left" : "top"] - r / 2) / (a - r),
        ...
        enableDraggable: function() {
            ...
            if (t.params.scrollbar.el) {
                ...
                et.touch ? (o.addEventListener(i.start, t.scrollbar.onDragStart, r),
                o.addEventListener(i.move, t.scrollbar.onDragMove, r),
                o.addEventListener(i.end, t.scrollbar.onDragEnd, a)) : (o.addEventListener(n.start, t.scrollbar.onDragStart, r),
        ...
        disableDraggable: function() {
            ...
            if (t.params.scrollbar.el) {
                ...
                et.touch ? (o.removeEventListener(i.start, t.scrollbar.onDragStart, r),
                o.removeEventListener(i.move, t.scrollbar.onDragMove, r),
                o.removeEventListener(i.end, t.scrollbar.onDragEnd, a)) : (o.removeEventListener(n.start, t.scrollbar.onDragStart, r),
      ...
      , F = {
        setTransform: function(t, e) {
            ...
            if (r || a ? (r = r || "0",
            a = a || "0") : this.isHorizontal() ? (r = o,
            a = "0") : (a = o,
            r = "0"),
            r = 0 <= r.indexOf("%") ? parseInt(r, 10) * e * s + "%" : r * e * s + "px",
            a = 0 <= a.indexOf("%") ? parseInt(a, 10) * e + "%" : a * e + "px",
            null != c) {
                var h = c - (c - 1) * (1 - Math.abs(e));
                n[0].style.opacity = h
            }
            if (null == l)
                n.transform("translate3d(" + r + ", " + a + ", 0px)");
            else {
        ...
        setTranslate: function() {
            ...
            e.each(function(t, e) {
                var i = e.progress;
                1 < n.params.slidesPerGroup && "auto" !== n.params.slidesPerView && (i += Math.ceil(t / 2) - s * (o.length - 1)),
                i = Math.min(Math.max(i, -1), 1),
                P(e).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(t, e) {
      ...
      , H = {
        ...
        onGestureStart: function(t) {
            ...
            n.$slideEl && n.$slideEl.length || (n.$slideEl = P(t.target).closest(".swiper-slide"),
        ...
        onGestureChange: function(t) {
            ...
            n.$imageEl && 0 !== n.$imageEl.length && (i.scale = et.gestures ? t.scale * i.currentScale : n.scaleMove / n.scaleStart * i.currentScale,
        ...
        onTouchStart: function(t) {
            var e = this.zoom
              , i = e.gesture
              , n = e.image;
            i.$imageEl && 0 !== i.$imageEl.length && (n.isTouched || (g.android && t.preventDefault(),
            n.isTouched = !0,
        ...
        in: function(t) {
            var e, i, n, s, o, r, a, l, c, h, d, u, p, f, m, g, v = this.zoom, y = this.params.zoom, b = v.gesture, _ = v.image;
            ...
            i = void 0 === _.touchesStart.x && t ? (e = "touchend" === t.type ? t.changedTouches[0].pageX : t.pageX,
            "touchend" === t.type ? t.changedTouches[0].pageY : t.pageY) : (e = _.touchesStart.x,
            _.touchesStart.y),
      ...
      , j = {
        loadInSlide: function(t, l) {
            ...
            if (void 0 !== t && 0 !== c.slides.length) {
                ...
                !d.hasClass(h.elementClass) || d.hasClass(h.loadedClass) || d.hasClass(h.loadingClass) || (e = e.add(d[0])),
        ...
        load: function() {
            ...
            n.params.watchSlidesVisibility)
                ...
                for (var h = t; h < t + a; h += 1)
                    l(h) && n.lazy.loadInSlide(h);
            else
                n.lazy.loadInSlide(t);
            if (r.loadPrevNext)
                if (1 < a || r.loadPrevNextAmount && 1 < r.loadPrevNextAmount) {
                    for (var d = r.loadPrevNextAmount, u = a, p = Math.min(t + u + Math.max(d, u), s.length), f = Math.max(t - Math.max(u, d), 0), m = t + a; m < p; m += 1)
      ...
      , B = {
        LinearSpline: function(t, e) {
            ...
            this.interpolate = function(t) {
                ...
                o = r - 1,
                (t - this.x[o]) * (this.y[r] - this.y[o]) / (this.x[r] - this.x[o]) + this.y[o]) : 0
            }
            ,
            this
        },
        ...
        setTranslate: function(t, e) {
            ...
            function r(t) {
                ...
                "slide" === s.params.controller.by && (s.controller.getInterpolateFunction(t),
                n = -s.controller.spline.interpolate(-e)),
                n && "container" !== s.params.controller.by || (i = (t.maxTranslate() - t.minTranslate()) / (s.maxTranslate() - s.minTranslate()),
      ...
      , R = {
        ...
        onEnterKey: function(t) {
            ...
            if (13 === t.keyCode) {
                ...
                e.pagination && n.is("." + e.params.pagination.bulletClass) && n[0].click()
            }
        },
        notify: function(t) {
      ...
      , X = {
        setTranslate: function() {
            var t, e = this, i = e.$el, n = e.$wrapperEl, s = e.slides, o = e.width, r = e.height, a = e.rtlTranslate, l = e.size, c = e.params.cubeEffect, h = e.isHorizontal(), d = e.virtual && e.params.virtual.enabled, u = 0;
            c.shadow && (h ? (0 === (t = n.find(".swiper-cube-shadow")).length && (t = P('<div class="swiper-cube-shadow"></div>'),
            n.append(t)),
            t.css({
                height: o + "px"
            })) : 0 === (t = i.find(".swiper-cube-shadow")).length && (t = P('<div class="swiper-cube-shadow"></div>'),
            i.append(t)));
            for (var p = 0; p < s.length; p += 1) {
                ...
                c.slideShadows) {
                    ...
                    0 === E.length && (E = P('<div class="swiper-slide-shadow-' + (h ? "left" : "top") + '"></div>'),
                    f.append(E)),
                    0 === T.length && (T = P('<div class="swiper-slide-shadow-' + (h ? "right" : "bottom") + '"></div>'),
                    f.append(T)),
        ...
        setTranslate: function() {
            for (var t = this.slides, e = this.rtlTranslate, i = 0; i < t.length; i += 1) {
                ...
                var o = -180 * s
                  ...
                  , l = 0;
                if (this.isHorizontal() ? e && (o = -o) : (l = a,
                r = -o,
                o = a = 0),
                ...
                this.params.flipEffect.slideShadows) {
                    ...
                    0 === c.length && (c = P('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'),
                    n.append(c)),
                    0 === h.length && (h = P('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'),
                    n.append(h)),
        ...
        setTranslate: function() {
            for (var t = this.width, e = this.height, i = this.slides, n = this.$wrapperEl, s = this.slidesSizesGrid, o = this.params.coverflowEffect, r = this.isHorizontal(), a = this.translate, l = r ? t / 2 - a : e / 2 - a, c = r ? o.rotate : -o.rotate, h = o.depth, d = 0, u = i.length; d < u; d += 1) {
                ...
                o.slideShadows) {
                    ...
                    0 === x.length && (x = P('<div class="swiper-slide-shadow-' + (r ? "left" : "top") + '"></div>'),
                    p.append(x)),
                    0 === E.length && (E = P('<div class="swiper-slide-shadow-' + (r ? "right" : "bottom") + '"></div>'),
                    p.append(E)),
        ...
        onThumbClick: function() {
            ...
            if (e) {
                ...
                if (!(n && P(n).hasClass(t.params.thumbs.slideThumbActiveClass) || null == i)) {
                    var s;
                    if (s = e.params.loop ? parseInt(P(e.clickedSlide).attr("data-swiper-slide-index"), 10) : i,
                    t.params.loop) {
                        var o = t.activeIndex;
        ...
        update: function(t) {
            ...
            if (i) {
                ...
                if (e.realIndex !== i.realIndex) {
                    ...
                    if (i.params.loop) {
                        i.slides.eq(o).hasClass(i.params.slideDuplicateClass) && (i.loopFix(),
                ...
                i.params.loop)
                    for (var h = 0; h < l; h += 1)
                        i.$wrapperEl.children('[data-swiper-slide-index="' + (e.realIndex + h) + '"]').addClass(c);
                else
                    for (var d = 0; d < l; d += 1)
      ...
      , K = [x, E, T, C, k, A, O, {
        ...
        on: {
            ...
            click: function(t) {
                ...
                !i.params.navigation.hideOnClick || P(t.target).is(o) || P(t.target).is(s) || (s ? e = s.hasClass(i.params.navigation.hiddenClass) : o && (e = o.hasClass(i.params.navigation.hiddenClass)),
        ...
        on: {
            ...
            click: function(t) {
                var e = this;
                e.params.pagination.el && e.params.pagination.hideOnClick && 0 < e.pagination.$el.length && !P(t.target).hasClass(e.params.pagination.bulletClass) && (!0 === e.pagination.$el.hasClass(e.params.pagination.hiddenClass) ? e.emit("paginationShow", e) : e.emit("paginationHide", e),
...
function(t, e) {
    ...
    , w = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], x = w.length, E = !1;
    return b
}),
function(t, e) {
    "use strict";
    ...
    var k, I, A, D, e = {
        init: function(C) {
            ...
            this.each(function() {
                ...
                ,
                o && (u.on("mouseenter", ".lavalamp-item", k),
                u.on("mouseleave", ".lavalamp-item", I)),
                l && (u.on("focusin", ".lavalamp-item", A),
                u.on("focusout", ".lavalamp-item", D)),
                c && (u.on("focusin", ".lavalamp-item *", A),
                u.on("focusout", ".lavalamp-item *", D)),
                e && p.click(function() {
                    f = S(this),
        ...
        destroy: function() {
            return this.each(function() {
                var t = S(this)
                  ...
                  , o = e.deepFocus
                  , r = e.autoUpdate;
                if (n && (t.off("mouseenter", ".lavalamp-item", k),
                t.off("mouseleave", ".lavalamp-item", I)),
                s && (t.off("focusin", ".lavalamp-item", A),
                t.off("focusout", ".lavalamp-item", D)),
                o && (t.off("focusin", ".lavalamp-item *", A),
                t.off("focusout", ".lavalamp-item *", D)),
    ...
    function i(t, e) {
        e = function t(e) {
            ...
            for (n = 1; n < arguments.length; n++) {
                var r = arguments[n] || {};
                for (i in r)
                    "object" != typeof o[i] || (s = o[i]) && "undefined" != typeof window && (s === window || s.nodeType) ? o[i] = o[i] || r[i] : o[i] = t(o[i], r[i])
            }
            return o
        }(e, i.options),
...
function(s) {
    s && (s.fn.headroom = function(n) {
        return this.each(function() {
            ...
            t.data("headroom", e)),
            "string" == typeof n && (e[n](),
            "destroy" === n && t.removeData("headroom"))
        })
    }
    ,
...
function(t) {
    ...
    function p(t, e) {
        ...
        m.st.callbacks[t] && m.st.callbacks[t].apply(m, h.isArray(e) ? e : [e]))
    }
    function f(t) {
        return t === e && m.currTemplate.closeBtn || (m.currTemplate.closeBtn = h(m.st.closeMarkup.replace("%title%", m.st.tClose)),
        e = t),
        m.currTemplate.closeBtn
    }
    function o() {
        h.magnificPopup.instance || ((m = new t).init(),
        h.magnificPopup.instance = m)
    }
    var m, n, g, s, v, e, a = "Close", l = "BeforeClose", y = "MarkupParse", i = ".mfp", b = "mfp-ready", r = "mfp-removing", c = "mfp-prevent-close", _ = !!window.jQuery, w = h(window);
    t.prototype = {
        constructor: t,
        init: function() {
        ...
        open: function(t) {
            ...
            if (!m.isOpen) {
                ...
                m.bgOverlay || (m.bgOverlay = u("bg").on("click.mfp", function() {
                    m.close()
                }),
                ...
                p("BeforeOpen"),
                m.st.showCloseBtn && (m.st.closeBtnInside ? (d(y, function(t, e, i, n) {
        ...
        close: function() {
            m.isOpen && (p(l),
            m.isOpen = !1,
            m.st.removalDelay && !m.isLowIE && m.supportsTransition ? (m._addClassToMFP(r),
            setTimeout(function() {
                m._close()
        ...
        updateItemHTML: function() {
            ...
            var e = t.type;
            if (p("BeforeChange", [m.currItem ? m.currItem.type : "", e]),
            m.currItem = t,
            !m.currTemplate[e]) {
                var i = !!m.st[e] && m.st[e].markup;
                p("FirstMarkupParse", i),
                m.currTemplate[e] = !i || h(i)
            }
        ...
        _onFocusIn: function(t) {
            return t.target === m.wrap[0] || h.contains(m.wrap[0], t.target) ? void 0 : (m._setFocus(),
            !1)
        },
                ...
                var i = 0
                  ...
                  , s = function(t) {
                    ...
                    P = setInterval(function() {
                        return 0 < n.naturalWidth ? void m._onImageHasSize(e) : (200 < i && clearInterval(P),
            ...
            getImage: function(t, e) {
                var i = 0
                  , n = function() {
                    ...
                    t.hasSize = !0,
                    t.loaded = !0,
                    p("ImageLoadComplete")) : ++i < 200 ? setTimeout(n, 100) : s())
                }
                  , s = function() {
    ...
    h.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(t) {
                ...
                M ? o["-moz-transform"] = o.transform = "translate(" + i.left + "px," + i.top + "px)" : (o.left = i.left,
                o.top = i.top),
                o
            }
        }
...
function(e) {
    ...
    function o(t, e, i) {
        ...
        a !== d && "" !== a && ((a = a.split(s.input_values_separator || e.input_values_separator || ";"))[0] && a[0] == +a[0] && (a[0] = +a[0]),
        a[1] && a[1] == +a[1] && (a[1] = +a[1]),
        e && e.values && e.values.length ? (n.from = a[0] && e.values.indexOf(a[0]),
        n.to = a[1] && e.values.indexOf(a[1])) : (n.from = a[0] && +a[0],
        n.to = a[1] && +a[1])),
        l.extend(n, e),
        l.extend(n, s),
        this.options = n,
    ...
    o.prototype = {
        ...
        remove: function() {
            ...
            s && (this.$cache.body.off("mouseup.irs_" + this.plugin_count),
            ...
            if (this.options) {
                ...
                if (!this.options.hide_from_to)
                    if ("single" === this.options.type)
                        t = o ? this.decorate(r[this.result.from]) : (n = this._prettify(this.result.from),
                        ...
                        i = o ? (this.options.decorate_both ? (t = this.decorate(r[this.result.from]),
                        ...
                        t += this.options.values_separator,
                        t += this.decorate(s, this.result.to)) : t = this.decorate(n + this.options.values_separator + s, this.result.to),
                        ...
                        h = this.result.from === this.result.to ? ("from" === this.target ? this.$cache.from[0].style.visibility = "visible" : "to" === this.target ? this.$cache.to[0].style.visibility = "visible" : this.target || (this.$cache.from[0].style.visibility = "visible"),
        ...
        drawShadow: function() {
            var t, e, i, n, s = this.options, o = this.$cache, r = "number" == typeof s.from_min && !isNaN(s.from_min), a = "number" == typeof s.from_max && !isNaN(s.from_max), l = "number" == typeof s.to_min && !isNaN(s.to_min), c = "number" == typeof s.to_max && !isNaN(s.to_max);
            ...
            o.shad_single[0].style.width = e + "%") : o.shad_single[0].style.display = "none" : (s.from_shadow && (r || a) ? (t = this.convertToPercent(r ? s.from_min : s.min),
            e = this.convertToPercent(a ? s.from_max : s.max) - t,
            t = this.toFixed(t - this.coords.p_handle / 100 * t),
            e = this.toFixed(e - this.coords.p_handle / 100 * e),
            t += this.coords.p_handle / 2,
            ...
            o.shad_from[0].style.width = e + "%") : o.shad_from[0].style.display = "none",
            s.to_shadow && (l || c) ? (i = this.convertToPercent(l ? s.to_min : s.min),
            ...
            o.shad_to[0].style.width = n + "%") : o.shad_to[0].style.display = "none")
        },
        ...
        convertToPercent: function(t, e) {
            ...
            return n ? (i = (e ? t : t - this.options.min) / s,
        ...
        convertToValue: function(t) {
            ...
            return h = d ? +h.toFixed(d.length) : (h /= this.options.step,
        ...
        checkMinInterval: function(t, e, i) {
            ...
            return o.min_interval ? (n = this.convertToValue(t),
            s = this.convertToValue(e),
            "from" === i ? s - n < o.min_interval && (n = s - o.min_interval) : n - s < o.min_interval && (n = s + o.min_interval),
            this.convertToPercent(n)) : t
        },
        checkMaxInterval: function(t, e, i) {
            var n, s, o = this.options;
            return o.max_interval ? (n = this.convertToValue(t),
            s = this.convertToValue(e),
            "from" === i ? s - n > o.max_interval && (n = s - o.max_interval) : n - s > o.max_interval && (n = s + o.max_interval),
            this.convertToPercent(n)) : t
        },
        ...
        decorate: function(t, e) {
            ...
            i += t,
            n.max_postfix && (n.values.length && t === n.p_values[n.max] ? (i += n.max_postfix,
            n.postfix && (i += " ")) : e === n.max && (i += n.max_postfix,
            n.postfix && (i += " "))),
        ...
        appendGrid: function() {
            if (this.options.grid) {
                ...
                t = 0; t < l + 1; t++) {
                    ...
                    e = 1; e <= n && 0 !== c; e++)
                        d += '<span class="irs-grid-pol small" style="left: ' + this.toFixed(c - s * e) + '%"></span>';
                    d += '<span class="irs-grid-pol" style="left: ' + c + '%"></span>',
                    o = this.convertToValue(c),
                    d += '<span class="irs-grid-text js-grid-text-' + t + '" style="left: ' + c + '%">' + (o = r.values.length ? r.p_values[o] : this._prettify(o)) + "</span>"
                }
        ...
        calcGridLabels: function() {
            ...
            n[s - 1] > 100 + this.coords.grid_gap && (n[s - 1] = 100 + this.coords.grid_gap,
        ...
        calcGridCollision: function(t, e, i) {
            ...
            for (n = 0; n < r && !(r <= (s = n + t / 2)); n += t)
                ...
                i[n] <= e[s] ? o.style.visibility = "visible" : o.style.visibility = "hidden"
        },
    ...
    ,
    function() {
        for (var o = 0, t = ["ms", "moz", "webkit", "o"], e = 0; e < t.length && !h.requestAnimationFrame; ++e)
            h.requestAnimationFrame = h[t[e] + "RequestAnimationFrame"],
            h.cancelAnimationFrame = h[t[e] + "CancelAnimationFrame"] || h[t[e] + "CancelRequestAnimationFrame"];
...
function(c, E, T) {
    ...
    var w, n, S = {
        ...
        var t = c.requestAnimationFrame || c[y.toLowerCase() + "RequestAnimationFrame"]
          , n = Tt();
    ...
    e.prototype.refresh = function(t) {
        ...
        J = [],
        Lt = 0,
        t = E.getElementsByTagName("*")) : t.length === T && (t = [t]),
        e = 0,
        i = t.length; e < i; e++) {
            var s = t[e]
              , o = s
                            ...
                            if ("data-edge-strategy" !== u.name)
                                if ("data-emit-events" !== u.name) {
                                    ...
                                    if (null !== p) {
                                        ...
                                        var v = p[3]
                                          , y = p[4] || v;
                                        v && "start" !== v && "end" !== v ? (f.mode = "relative",
                                        f.anchors = [v, y]) : (f.mode = "absolute",
                                        "end" === v ? f.isEnd = !0 : f.isPercentage || (f.offset = f.offset * kt))
                                    }
                                } else
                                    c = !0;
                            else
    ...
    e.prototype.relativeToAbsolute = function(t, e, i) {
        var n = w.clientHeight
          ...
          , o = s.top
          , r = s.bottom - s.top;
        return "bottom" === e ? o -= n : "center" === e && (o -= n / 2),
        "bottom" === i ? o += r : "center" === i && (o += r / 2),
        0 | (o += Z.getScrollTop()) + .5
    }
    ,
    e.prototype.animateTo = function(t, e) {
        ...
        }).topDiff || (ot.done && ot.done.call(Z, !1),
        ot = T),
        Z
    }
    ,
    e.prototype.stopAnimateTo = function() {
        ot && ot.done && ot.done.call(Z, !0),
        ot = T
    }
    ,
    ...
    var R = function() {
      ...
      , q = function() {
        ...
        if (ot)
            n >= ot.endTime ? (i = ot.targetTop,
            t = ot.done,
            ot = T) : (e = ot.easing((n - ot.startTime) / ot.duration),
            ...
            lt.endTime >= n && (e = B.sqrt((n - lt.startTime) / at),
            i = 0 | lt.startTop + e * lt.topDiff)
        }
        if ($t && tt && S.setStyle(tt, "transform", "translate(0, " + -Nt + "px) " + dt),
        ct || At !== i) {
            var s = {
                curTop: i,
                lastTop: At,
            ...
            (ct = !1) !== (et.beforerender && et.beforerender.call(Z, s)) && (function(t, e) {
                for (var i = 0, n = J.length; i < n; i++) {
                    var s, o, r = J[i], a = r.element, l = r.smoothScrolling ? t : e, c = r.keyFrames, h = c.length, d = c[0], u = c[c.length - 1], p = d.frame > l, f = l > u.frame, m = p ? d : u, g = r.emitEvents, v = r.lastFrameIndex;
                    if (p || f) {
                        if (p && -1 === r.edge || f && 1 === r.edge)
                            continue;
                        switch (p ? (wt(a, [O], [$, L]),
                        g && -1 < v && (gt(a, d.eventType, It),
                        r.lastFrameIndex = -1)) : (wt(a, [$], [O, L]),
                        g && v < h && (gt(a, u.eventType, It),
                        r.lastFrameIndex = h)),
                        r.edge = p ? -1 : 1,
                        r.edgeStrategy) {
                        case "reset":
                        ...
                        case "set":
                            var y = m.props;
                            for (s in y)
                                k.call(y, s) && (o = U(y[s].value),
                                0 === s.indexOf("@") ? a.setAttribute(s.substr(1), o) : S.setStyle(a, s, o));
                            continue
                        }
                    } else
                        0 !== r.edge && (wt(a, [M, L], [O, $]),
                    ...
                    for (var b = 0; b < h - 1; b++)
                        if (l >= c[b].frame && c[b + 1].frame >= l) {
                            ...
                            g && v !== b && (gt(a, "down" === It ? _.eventType : w.eventType, It),
                            r.lastFrameIndex = b);
                            break
                        }
                }
      ...
      , W = function(t) {
        for (var e = 0, i = t.keyFrames.length; e < i; e++) {
            for (var n, s, o, r, a = t.keyFrames[e], l = {}; null !== (r = u.exec(a.props)); )
                o = r[1],
                s = r[2],
                n = null !== (n = o.match(p)) ? (o = n[1],
                n[2]) : "linear",
      ...
      , V = function(t) {
        var e, i, n = {};
        for (e = 0,
        i = t.keyFrames.length; e < i; e++)
            X(t.keyFrames[e], n);
        for (n = {},
        e = t.keyFrames.length - 1; 0 <= e; e--)
            X(t.keyFrames[e], n)
    }
      , X = function(t, e) {
        var i;
        for (i in e)
            k.call(t.props, i) || (t.props[i] = e[i]);
        for (i in t.props)
            e[i] = t.props[i]
    }
      , G = function(t, e, i) {
      ...
      , Q = function(t, e) {
        for (var i, n, s = 0, o = (t = [].concat(t)).length; s < o; s++)
            n = t[s],
            (i = J[n[N]]) && (e ? (n.style.cssText = i.dirtyStyleAttr,
            wt(n, i.dirtyClassAttr)) : (i.dirtyStyleAttr = n.style.cssText,
    ...
    var Z, J, tt, et, it, nt, st, ot, rt, at, lt, ct, ht, dt, ut, pt = S.addEvent = function(t, e, i) {
        for (var n, s = function(t) {
            return (t = t || c.event).target || (t.target = t.srcElement),
            ...
            i.call(this, t)
        }, o = 0, r = (e = e.split(" ")).length; o < r; o++)
            n = e[o],
            t.addEventListener ? t.addEventListener(n, i, !1) : t.attachEvent("on" + n, s),
            zt.push({
                element: t,
                name: n,
                listener: i
    ...
    , mt = function() {
        for (var t, e = 0, i = zt.length; e < i; e++)
            t = zt[e],
            ft(t.element, t.name, t.listener);
        zt = []
    }, gt = function(t, e, i) {
        ...
        function() {
            ...
            l = J.length; a < l; a++)
                ...
                o = (n = t.keyFrames).length; s < o; s++)
                    ...
                    r.frame = c),
                    "relative" === r.mode && (Q(e),
                    r.frame = Z.relativeToAbsolute(i, r.anchors[0], r.anchors[1]) - c,
                    Q(e, !0)),
                    r.frame += h,
            ...
            l = J.length; a < l; a++) {
                for (s = 0,
                o = (n = (t = J[a]).keyFrames).length; s < o; s++)
        ...
        $t ? Z.setScrollTop(x.min(Z.getScrollTop(), St)) : Z.setScrollTop(t, !0),
        ct = !0
    }, yt = function() {
        var t, e, i = w.clientHeight, n = {};
        for (t in nt)
            "function" == typeof (e = nt[t]) ? e = e.call(Z) : /p$/.test(e) && (e = e.slice(0, -1) / 100 * i),
            n[t] = e;
        return n
    }, bt = function() {
        ...
        var e = "className";
        return c.SVGElement && t instanceof c.SVGElement && (t = t[e],
        e = "baseVal"),
        t[e]
    }, wt = function(t, e, i) {
        var n = "className";
        if (c.SVGElement && t instanceof c.SVGElement && (t = t[n],
        n = "baseVal"),
        i === T)
            return t[n] = e,
            T;
    ...
    return function(n, t) {
        ...
        C.animateScroll = function(r, a, t) {
            ...
            if (c || e) {
                ...
                var i, n, s, d, o, u, p, f, m = function(t) {
                    return t ? (e = t,
                    parseInt(S.getComputedStyle(e).height, 10) + t.offsetTop) : 0;
                    var e
                    ...
                    s
                }(e, m, parseInt("function" == typeof l.offset ? l.offset(r, a) : l.offset, 10), l.clip), v = g - h, y = I(), b = 0, _ = (i = v,
                s = (n = l).speedAsDuration ? n.speed : Math.abs(i / 1e3 * n.speed),
                n.durationMax && s > n.durationMax ? n.durationMax : n.durationMin && s < n.durationMin ? n.durationMin : parseInt(s, 10)), w = function(t) {
                    var e, i, n;
                    b += t - (d = d || t),
                    u = h + v * (i = o = 1 < (o = 0 === _ ? 0 : b / _) ? 1 : o,
                    "easeInQuad" === (e = l).easing && (n = i * i),
                    "easeOutQuad" === e.easing && (n = i * (2 - i)),
                    "easeInOutQuad" === e.easing && (n = i < .5 ? 2 * i * i : (4 - 2 * i) * i - 1),
                    "easeInCubic" === e.easing && (n = i * i * i),
                    "easeOutCubic" === e.easing && (n = --i * i * i + 1),
                    "easeInOutCubic" === e.easing && (n = i < .5 ? 4 * i * i * i : (i - 1) * (2 * i - 2) * (2 * i - 2) + 1),
                    "easeInQuart" === e.easing && (n = i * i * i * i),
                    "easeOutQuart" === e.easing && (n = 1 - --i * i * i * i),
                    "easeInOutQuart" === e.easing && (n = i < .5 ? 8 * i * i * i * i : 1 - 8 * --i * i * i * i),
                    "easeInQuint" === e.easing && (n = i * i * i * i * i),
                    "easeOutQuint" === e.easing && (n = 1 + --i * i * i * i * i),
                    "easeInOutQuint" === e.easing && (n = i < .5 ? 16 * i * i * i * i * i : 1 + 16 * --i * i * i * i * i),
                    ...
                    function(t, e) {
                        ...
                        if (t == e || o == e || (h < e && S.innerHeight + o) >= y)
                            ...
                            s || (i.focus(),
                            document.activeElement !== i && (i.setAttribute("tabindex", "-1"),
                            i.focus(),
                            i.style.outline = "none"),
                            S.scrollTo(0, n)),
                            A("scrollStop", l, r, a),
                            !(T = d = null)
                    }(u, g) || (T = S.requestAnimationFrame(w),
                    d = t)
                };
                0 === S.pageYOffset && S.scrollTo(0, 0),
                p = r,
                f = l,
                c || history.pushState && f.updateURL && history.pushState({
                    smoothScroll: JSON.stringify(f),
                    anchor: p.id
                }, document.title, p === document.documentElement ? "#top" : "#" + p.id),
                "matchMedia"in S && S.matchMedia("(prefers-reduced-motion)").matches ? S.scrollTo(0, Math.floor(g)) : (A("scrollStart", l, r, a),
                C.cancelScroll(!0),
        ...
        function e(t) {
            if (!t.defaultPrevented && !(0 !== t.button || t.metaKey || t.ctrlKey || t.shiftKey) && "closest"in t.target && (s = t.target.closest(n)) && "a" === s.tagName.toLowerCase() && !t.target.closest(x.ignore) && s.hostname === S.location.hostname && s.pathname === S.location.pathname && /#/.test(s.href)) {
                ...
                (e = e || "#top" !== i ? e : document.documentElement) && (t.preventDefault(),
                function(t) {
        ...
        function i(t) {
            if (null !== history.state && history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(x)) {
                ...
                "string" == typeof e && e && !(e = document.querySelector(o(history.state.anchor))) || C.animateScroll(e, null, {
                    updateURL: !1
                })
            }
        }
        return C.destroy = function() {
            x && (document.removeEventListener("click", e, !1),
        ...
        ,
        function() {
            if (!("querySelector"in document && "addEventListener"in S && "requestAnimationFrame"in S && "closest"in S.Element.prototype))
                throw "Smooth Scroll: This browser does not support the required JavaScript methods and browser APIs.";
            C.destroy(),
            x = k(D, t || {}),
            E = x.header ? document.querySelector(x.header) : null,
            document.addEventListener("click", e, !1),
            x.updateURL && x.popstate && S.addEventListener("popstate", i, !1)
        }(),
        C
    }
}),
function(t) {
    ...
    function r(t, e, i) {
        ...
        this.$el.on("finish.countdown", i)) : this.options = s.extend({}, n, i)),
        this.setFinalDate(e),
                    ...
                    if (a)
                        for (var l = 0, c = a.length; l < c; ++l) {
                            var h = a[l].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/)
                              , d = (o = h[0],
                            void 0,
                            r = o.toString().replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"),
                            new RegExp(r))
                              , u = h[1] || ""
                              , p = h[3] || ""
                              , f = null;
                            h = h[2],
                            g.hasOwnProperty(h) && (f = g[h],
                            f = Number(m[f])),
                            null !== f && ("!" === u && (i = f,
                            s = n = void 0,
                            n = "s",
    ...
    s.fn.countdown = function() {
        ...
        return this.each(function() {
            ...
            if (void 0 !== t) {
                var e = o[t]
                  , i = n[0];
                r.prototype.hasOwnProperty(i) ? e[i].apply(e, n.slice(1)) : null === String(i).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (e.setFinalDate.call(e, i),
                e.start()) : s.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, i))
            } else
                new r(this,n[0],n[1])
        })
    }
...
function(t, e) {
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t, e, i, n, s) {
            return "function" == typeof t.addEventListener ? o.apply(null, arguments) : "function" == typeof i ? o.bind(null, document).apply(null, arguments) : ("string" == typeof t && (t = document.querySelectorAll(t)),
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}
  , Prism = function(c) {
    var h = /\blang(?:uage)?-([\w-]+)\b/i
      ...
      , P = {
            ...
            DFS: function t(e, i, n, s) {
                ...
                for (var r in e)
                    if (e.hasOwnProperty(r)) {
                        ...
                        var a = e[r]
                          , l = P.util.type(a);
                        "Object" !== l || s[o(a)] ? "Array" !== l || s[o(a)] || (s[o(a)] = !0,
                        t(a, i, r, s)) : (s[o(a)] = !0,
                        t(a, i, null, s))
                    }
            }
        ...
        highlightAllUnder: function(t, e, i) {
            ...
            for (var s, o = n.elements || t.querySelectorAll(n.selector), r = 0; s = o[r++]; )
                P.highlightElement(s, !0 === e, n.callback)
        },
        highlightElement: function(t, e, i) {
            for (var n, s, o = t; o && !h.test(o.className); )
                o = o.parentNode;
            o && (n = (o.className.match(h) || [, ""])[1].toLowerCase(),
            s = P.languages[n]),
            t.className = t.className.replace(h, "").replace(/\s+/g, " ") + " language-" + n,
            t.parentNode && (o = t.parentNode,
            /pre/i.test(o.nodeName) && (o.className = o.className.replace(h, "").replace(/\s+/g, " ") + " language-" + n));
            function r(t) {
                a.highlightedCode = t,
            ...
            if (P.hooks.run("before-sanity-check", a),
            a.code)
                if (P.hooks.run("before-highlight", a),
                a.grammar)
                    if (e && c.Worker) {
                        ...
                        r(P.highlight(a.code, a.grammar, a.language));
                else
                    r(P.util.encode(a.code));
            else
                P.hooks.run("complete", a)
        },
            ...
            for (var a in i)
                if (i.hasOwnProperty(a) && i[a]) {
                    ...
                    for (var c = 0; c < l.length; ++c) {
                        ...
                        h = h.pattern || h;
                        for (var v = n, y = s; v < e.length; y += e[v].length,
                        ++v) {
                            var b = e[v];
                            ...
                            if (!(b instanceof M)) {
                                if (p && v != e.length - 1) {
                                    ...
                                    !(C = h.exec(t)))
                                        break;
                                    for (var _ = C.index + (u ? C[1].length : 0), w = C.index + C[0].length, x = v, E = y, T = e.length; x < T && (E < w || !e[x].type && !e[x - 1].greedy); ++x)
                                        (E += e[x].length) <= _ && (++v,
                                        y = E);
                                    if (e[v]instanceof M)
                                        continue;
        ...
        tokenize: function(t, e) {
            ...
            return P.matchGrammar(t, i, e, 0, 0, !1),
            i
        },
        hooks: {
            all: {},
    ...
    ,
    !c.document)
        return c.addEventListener && (P.disableWorkerMessageHandler || c.addEventListener("message", function(t) {
    ...
    return t && (P.filename = t.src,
    P.manual || t.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(P.highlightAll) : window.setTimeout(P.highlightAll, 16) : document.addEventListener("DOMContentLoaded", P.highlightAll))),
    P
}(_self);
...
"undefined" != typeof self && self.Prism && self.document && document.querySelector && (self.Prism.fileHighlight = function(t) {
    ...
    Array.prototype.slice.call(t.querySelectorAll("pre[data-src]")).forEach(function(t) {
        if (!t.hasAttribute("data-src-loaded")) {
            for (var e, i = t.getAttribute("data-src"), n = t, s = /\blang(?:uage)?-([\w-]+)\b/i; n && !s.test(n.className); )
                n = n.parentNode;
            if (n && (e = (t.className.match(s) || [, ""])[1]),
            !e) {
                var o = (i.match(/\.(\w+)$/) || [, ""])[1];
                e = l[o] || o
            }
            ...
            a.onreadystatechange = function() {
                4 == a.readyState && (a.status < 400 && a.responseText ? (r.textContent = a.responseText,
                Prism.highlightElement(r),
                t.setAttribute("data-src-loaded", "")) : 400 <= a.status ? r.textContent = "✖ Error " + a.status + " while fetching file: " + a.statusText : r.textContent = "✖ Error: File does not exist or is empty")
            }
            ,
            a.send(null)
        }
    ...
    if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        var t = Prism.plugins.toolbar.registerButton = function(t, i) {
            ...
            e = "function" == typeof i ? i : function(t) {
                var e;
                return "function" == typeof i.onClick ? ((e = document.createElement("button")).type = "button",
                e.addEventListener("click", function() {
                    i.onClick.call(this, t)
                })) : "string" == typeof i.url ? (e = document.createElement("a")).href = i.url : e = document.createElement("span"),
          ...
          , e = Prism.plugins.toolbar.hook = function(n) {
            ...
            if (t && /pre/i.test(t.nodeName) && !t.parentNode.classList.contains("code-toolbar")) {
                ...
                document.body.hasAttribute("data-toolbar-order") && (o = document.body.getAttribute("data-toolbar-order").split(",").map(function(t) {
                    return r[t] || i
                })),
...
function(f) {
    ...
    f.zoom = function(t, e, n, i) {
        ...
        return t.style.position = /(absolute|fixed)/.test(u) ? u : "relative",
        t.style.overflow = "hidden",
        n.style.width = n.style.height = "",
        f(n).addClass("zoomImg").css({
            position: "absolute",
            top: 0,
            left: 0,
            opacity: 0,
    ...
    f.fn.zoom = function(i) {
        return this.each(function() {
            ...
            if (!s.url) {
                ...
                if (e && (s.url = e.getAttribute("data-src") || e.currentSrc || e.src),
                !s.url)
                    return
            }
            ...
            a.onload = function() {
                ...
                function i(t) {
                    e.init(),
                    e.move(t),
                    l.stop().fadeTo(f.support.opacity ? s.duration : 0, 1, !!f.isFunction(s.onZoomIn) && s.onZoomIn.call(a))
                }
                function n() {
                ...
                "grab" === s.on ? r.on("mousedown.zoom", function(t) {
                    ...
                    h ? n() : i(t),
                    h = !h
                }) : "mouseover" === s.on && (e.init(),
                r.on("mouseenter.zoom", i).on("mouseleave.zoom", n).on(c, e.move)),
                s.touch && r.on("touchstart.zoom", function(t) {
                    t.preventDefault(),
                    d ? (d = !1,
                    n()) : (d = !0,
